...
export const AddWorkTimeModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 transform transition-all border-b border-gray-500">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 ">
          ...
          <div className="mb-4">
            <label htmlFor="stunden" className="block text-sm font-medium text-gray-700 mb-1">
              Stunden:
            </label>
            <input
              type="number"
