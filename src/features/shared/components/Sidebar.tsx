    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto">
          <div className="px-4 py-3 mt-5 text-s font-semibold text-gray-400 uppercase">ARBEITSZEITEN</div>
          <ul className="space-y-1 px-2">
            <NavItem icon={icons.home} label="Dashboard" navigateTo="/dashboard" onClick={closeSidebarOnMobile} />
            <NavItem
              icon={icons.calendar}
          ...
          <div className="px-4 py-3 mt-5 text-s font-semibold text-gray-400 uppercase">EVENT PLANUNG</div>
          <ul className="space-y-1 px-2">
            <NavItem icon={icons.absence} label="Einteilung" navigateTo="/plan" onClick={closeSidebarOnMobile} />
          </ul>
        </nav>
        {/* Footer */}
